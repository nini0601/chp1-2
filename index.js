...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[1316,1372,400,400],[1686,1774,359,320],[1316,1774,368,322],[0,3152,1411,107],[0,3261,1395,107],[1316,2206,311,107],[1779,2096,200,200],[0,0,1314,740],[1718,1372,200,200],[0,2226,1314,740],[1805,2546,200,51],[0,2968,1177,182],[1316,0,698,497],[0,3478,1060,108],[0,742,1314,740],[0,1484,1314,740],[1976,651,50,50],[1533,2583,80,80],[1316,2531,120,120],[1920,1336,120,120],[1918,1092,120,120],[1615,2583,80,80],[1918,1214,120,120],[1920,1458,120,120],[1916,1580,120,120],[1316,970,600,400],[1629,2206,80,80],[1918,970,120,120],[1316,2315,261,106],[0,3370,1393,106],[1316,2098,461,106],[1316,499,658,469],[1179,2968,861,106],[1438,2583,93,103],[1718,1574,196,195],[1976,499,67,74],[1916,1702,129,20],[1946,2298,94,102],[1976,575,67,74],[0,3588,1061,106],[1062,3478,854,106],[1316,2423,161,106],[1642,2475,161,106],[1806,2298,138,138],[1806,2438,161,106],[1629,2298,175,175],[1479,2475,161,106]]}
];
...
(lib.index = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(13).call(this.frame_13).wait(6).call(this.frame_19).wait(205).call(this.frame_224).wait(34).call(this.frame_258).wait(35).call(this.frame_293).wait(978).call(this.frame_1271).wait(33).call(this.frame_1304).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.home},{t:this.instance_1},{t:this.instance}]},19).to({state:[{t:this.home},{t:this.hint},{t:this.local}]},205).to({state:[{t:this.home},{t:this.hint}]},1).to({state:[{t:this.home},{t:this.hint}]},33).to({state:[{t:this.home},{t:this.instance_1},{t:this.instance}]},6).to({state:[{t:this.home},{t:this.hint},{t:this.local}]},1007).to({state:[{t:this.home},{t:this.local},{t:this.hint}]},33).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.EEEE).wait(1304).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.GOGOGOGO).wait(258).to({_off:false},0).to({_off:true},1).wait(1046));
	...
	this.timeline.addTween(cjs.Tween.get(this.next).wait(1271).to({_off:false},0).to({_off:true},1).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1028).to({_off:false},0).wait(228).to({_off:true},1).wait(48));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},861).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},109).to({state:[]},1).wait(334));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(849).to({_off:false},0).to({x:897.8},8).wait(113).to({startPosition:0},0).to({x:812.7},5).to({regX:0,regY:0,x:2193.7,y:567.7},7).to({_off:true},1).wait(322));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(572).to({_off:false},0).to({alpha:1},15).wait(45).to({alpha:0},16).to({_off:true},1).wait(656));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(536).to({_off:false},0).to({alpha:1},16).wait(80).to({alpha:0},16).to({_off:true},1).wait(656));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_11}]},388).to({state:[{t:this.instance_12}]},118).to({state:[{t:this.instance_12}]},7).to({state:[{t:this.instance_13}]},225).to({state:[{t:this.instance_13}]},6).to({state:[{t:this.instance_14}]},62).to({state:[{t:this.instance_14}]},20).to({state:[]},29).to({state:[{t:this.instance_15}]},6).to({state:[{t:this.instance_16}]},129).to({state:[{t:this.instance_16}]},11).to({state:[{t:this.instance_17}]},9).to({state:[{t:this.instance_17}]},8).to({state:[{t:this.instance_18}]},97).to({state:[{t:this.instance_18}]},141).to({state:[]},1).wait(48));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(506).to({_off:false},0).to({alpha:1},7).to({_off:true},225).wait(567));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(738).to({_off:false},0).to({alpha:1},6).to({_off:true},62).wait(499));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(806).to({_off:false},0).to({alpha:1},20).to({_off:true},29).wait(450));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(990).to({_off:false},0).to({alpha:0},11).to({_off:true},9).wait(295));
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(1010).to({_off:false},0).to({alpha:1},8).to({_off:true},97).wait(190));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_19}]},436).to({state:[{t:this.instance_19}]},24).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text,p:{text:"Genius"}}]},232).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text,p:{text:"Geniu"}}]},3).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text,p:{text:"Geni"}}]},4).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text,p:{text:"Gen"}}]},5).to({state:[{t:this.instance_20}]},9).to({state:[{t:this.instance_21}]},23).to({state:[{t:this.instance_21}]},9).to({state:[{t:this.instance_21}]},20).to({state:[{t:this.instance_21}]},41).to({state:[{t:this.instance_21}]},37).to({state:[]},429).wait(33));
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(436).to({_off:false},0).to({alpha:1},24).to({_off:true},232).wait(613));
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(713).to({_off:false},0).to({_off:true,x:1057.7,y:589.8,alpha:0},23).wait(569));
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(713).to({_off:false},23).wait(9).to({alpha:0.16},0).to({alpha:1},20).wait(41).to({startPosition:0},0).to({alpha:0},37).to({_off:true},429).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(225).to({_off:false},0).wait(39).to({alpha:1},8).to({_off:true},1000).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_29}]},225).to({state:[{t:this.instance_29}]},39).to({state:[{t:this.instance_29},{t:this.next_1},{t:this.instance_30}]},1010).to({state:[{t:this.instance_29},{t:this.next_1},{t:this.instance_30}]},30).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.nissannext).wait(222).to({_off:false},0).wait(2).to({_off:true},1).wait(1080));
	...
	this.timeline.addTween(cjs.Tween.get(this.nissanword).wait(9).to({_off:false},0).to({alpha:1},34).wait(70).to({_off:true},1).wait(1191));
	...
	this.timeline.addTween(cjs.Tween.get(this.nissan2).wait(114).to({_off:false},0).to({alpha:0.949},18).to({alpha:1},2).wait(90).to({_off:true},1).wait(1080));
	...
	this.timeline.addTween(cjs.Tween.get(this.nissan1).to({alpha:1},23).wait(90).to({_off:true},1).wait(1191));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1482917846657", id:"index_atlas_"},
		{src:"sounds/_121wav.mp3?1482917846824", id:"_121wav"},
		{src:"sounds/_12wav.mp3?1482917846824", id:"_12wav"}
	],
	preloads: []
};
